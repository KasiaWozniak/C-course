...
constexpr const char* const FIRSTNAME = "Katarzyna";
constexpr const char* const SURNAME   = "Woźniak";
constexpr const char* const MAIL    = "katarzynawoz@student.agh.edu.pl";
constexpr const char* const BOOK_ID = "414952";
