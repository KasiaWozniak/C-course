...
{
    // TODO:
    string distribution_="Ubuntu";
    static size_t open_source_sympathizers_;
    vector<User> users_;
...
public:
    ...
    ~Linux();
    int add_user(string user_name, string password);
    User user(int user_id);
    string user_home_directory(int user_id);
    const optional<string> graphic_environment();
    optional<string> set_graphic_environment(string graphic);
};
